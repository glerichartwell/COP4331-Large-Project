...
var logger$2 = require('@firebase/logger');
 ...
 * limitations under the License.
 */
const logger$1 = new logger$2.Logger('@firebase/app');
...
new util.ErrorFactory('app', 'Firebase', ERRORS);
...
function registerVersion(libraryKeyOrName, version, variant) {
    ...
    _registerComponent(new component.Component(`${library}-version`, () => ({ library, version }), "VERSION" /* VERSION */));
}
...
function registerCoreComponents(variant) {
    _registerComponent(new component.Component('platform-logger', container => new PlatformLoggerServiceImpl(container), "PRIVATE" /* PRIVATE */));
 ...
 * limitations under the License.
 */
const logClient$1 = new logger$2.Logger('@firebase/database');
/**
...
const enableLogging$1 = function (logger_, persistent) {
    ...
    if (logger_ === true) {
        logClient$1.logLevel = logger$2.LogLevel.VERBOSE;
...
const validateFirebaseMergeDataArg = function (fnName, data, path, optional) {
    ...
    const errorPrefix$1 = util.errorPrefix(fnName, 'values');
...
function registerDatabase(variant) {
    ...
    _registerComponent(new component.Component('database', (container, { instanceIdentifier: url }) => {
 ...
 * limitations under the License.
 */
var logClient = new logger$2.Logger('@firebase/database-compat');
